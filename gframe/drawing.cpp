...
void Game::DrawSpec() {
	...
	if(showcard) {
		...
		case 7: {
			...
			if(xScale > yScale)
				mul = yScale;
			irr::core::position2d<irr::s32> corner[4];
			...
			corner[0] = irr::core::position2d<irr::s32>(winx - (CARD_IMG_HEIGHT * mul - y) * 0.3f, winy - y);
			corner[1] = irr::core::position2d<irr::s32>(winx2 + (CARD_IMG_HEIGHT * mul - y) * 0.3f, winy - y);
			corner[2] = irr::core::position2d<irr::s32>(winx, winy);
			corner[3] = irr::core::position2d<irr::s32>(winx2, winy);
