...
class DuelClient {
private:
	static inline bufferevent* client_bev{};
	static inline unsigned char duel_client_write[SIZE_NETWORK_BUFFER]{};

public:
	static inline unsigned char selftype{};
	...
	static inline std::vector<HostPacket> hosts{};
